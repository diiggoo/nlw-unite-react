            ...
            <table className="w-full">
                <thead>
                    <tr className="border-b border-white/10">
                        ...
                        <th className="py-3 px-4 text-sm font-semibold text-left">Data de Checkin</th>
                            ...
                            <tr key={i} className="border-b border-white/10">
                                ...
                                <td className="py-3 px-4 text-sm text-zinc-300">
                                    <div className="flex flex-col gap-1">
                                        <span className="font-semibold text-white">Rodrigo Moreira</span>
                                        <span>rodrigo.moreira@rodrigo.com</span>
                                    </div>
                                </td>
